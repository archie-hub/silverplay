...
app = Dash(__name__,  routes_pathname_prefix='/silver/', title='No ssl - Work in progress')
...
app.layout = html.Div(
    [
        ...
        html.H1(
            "Gold/Silver Holdings - scroll down - work in progress - will look bad on phone for now",
